...
export default function ContactUsPage() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#113228_0%,_#0a1b16_45%,_#040a08_100%)] px-3 py-6 text-[#F5E6B3] sm:px-6 sm:py-8 lg:px-8 lg:py-10">
