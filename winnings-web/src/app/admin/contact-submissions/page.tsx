            ...
            <tbody>
              {submissions.map((s, idx) => (
                <tr key={idx} className="border-t border-amber-200/20 odd:bg-black/25 even:bg-black/45">
                  <td className="px-4 py-3 whitespace-nowrap">{s.submittedAt || "ï¿½"}</td>
                  <td className="px-4 py-3 whitespace-nowrap">{s.name || "ï¿½"}</td>
                  <td className="px-4 py-3 whitespace-nowrap">{s.email || "ï¿½"}</td>
                  <td className="px-4 py-3 whitespace-nowrap">{s.phone || "ï¿½"}</td>
                  <td className="px-4 py-3">{s.message || "ï¿½"}</td>
                </tr>
              ))}
            </tbody>
          </table>
